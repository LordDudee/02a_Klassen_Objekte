...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Cat cat1 = new Cat("Grizabella", "white", 22); // Klasse --> Objekt / Instanz   // Referenzvariable = cat1 
        ...
        Cat cat2 = new Cat("Alonzo", "black", 27); // Klasse --> Objekt / Instanz     // Referenzvariable = cat1 
        // cat2.setName("#?!3$");
